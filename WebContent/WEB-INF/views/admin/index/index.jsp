 ...
 <div class="row">
    <div class="col-md-12 panel-warning">
        ...
        <span class="glyphicon glyphicon-th-list"></span>
                        ...
                        <div class="text-box">
                            <p class="main-text"><a class="fs-14" href="${pageContext.request.contextPath}/admin/land/index" title="">Quản lý thông báo</a></p>
                            <p class="text-muted">Có 4 danh mục</p>
                        </div>
                    </div>
                </div>
        ...
        <span class="glyphicon glyphicon-th-list"></span>
                        ...
                        <div class="text-box">
                            <p class="main-text"><a class="fs-14" href="${pageContext.request.contextPath}/admin/land/index" title="">Quản lý học phí</a></p>
                            <p class="text-muted">Có 4 danh mục</p>
                        </div>
                    </div>
                </div>
        ...
        <span class="glyphicon glyphicon-user"></span>
                        ...
                        <div class="text-box">
                            <p class="main-text"><a class="fs-14" href="${pageContext.request.contextPath}/admin/student/index" title="">Quản lý sinh viên</a></p>
                            <p class="text-muted">Có 5 người dùng</p>
                        </div>
                    </div>
                </div>
